/*
  # Fix Admin Documents Complete Setup

  This migration resolves all issues with the admin documents functionality:

  1. Storage Setup
     - Creates 'documents' storage bucket if it doesn't exist
     - Adds proper RLS policies for file operations

  2. Database Functions
     - Creates all required RPC functions for document management
     - Handles CRUD operations with proper error handling

  3. RLS Policies
     - Updates admin_documents table policies for proper access control
